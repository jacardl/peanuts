...
r1d_wifi2G_log = ['wl -i wl1 dump wlc', 'wl -i wl1 dump bsscfg', 'wl -i wl1 dump dma',
                  ...
                  'wl -i wl1 scanresults', 'wl -i wl1 assoclist', 'iwpriv wl1 set AutoChannelSel=4 ; iwpriv wl1 ScanResult',
...
r1d_wifi5G_log = ['wl -i wl0 dump wlc', 'wl -i wl0 dump bsscfg', 'wl -i wl0 dump dma',
                  ...
                  'wl -i wl0 scanresults', 'wl -i wl0 assoclist', 'iwpriv wl0 set AutoChannelSel=4 ; iwpriv wl0 ScanResult',
