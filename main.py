...
class TestSuitePage(wx.Panel):
    def __init__(self, parent):
        ...
        self.rootInternelAccessApi = self.tree.AppendItem(self.root, 'Internel Access Control', ct_type=1)
        ...
        self.AddTreeNodes(self.rootInternelAccessApi, data.treeInternetAccessApi)
